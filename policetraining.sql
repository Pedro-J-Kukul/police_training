...
\restrict sHB3SV53P6fIhMyGe8vtol5P4pDlIwx7ptEbleRFjdt0vbzvIvZWuShxYBMABGp
...
ALTER SEQUENCE public.officers_id_seq OWNER TO police;

--
-- Name: officers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: police
--
...
CREATE TABLE public.ranks (
    ...
    rank text NOT NULL,
    code text NOT NULL,
    annual_training_hours_required integer DEFAULT 40 NOT NULL
);
...
--
-- Name: officers id; Type: DEFAULT; Schema: public; Owner: police
--
...
--
-- Name: training_types training_types_type_key; Type: CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.training_types
    ADD CONSTRAINT training_types_type_key UNIQUE (type);
...
--
-- Name: tokens_hash_scope_idx; Type: INDEX; Schema: public; Owner: police
--

CREATE INDEX tokens_hash_scope_idx ON public.tokens USING btree (hash, scope);


--
-- Name: users_email_search_idx; Type: INDEX; Schema: public; Owner: police
--

CREATE INDEX users_email_search_idx ON public.users USING gin (to_tsvector('simple'::regconfig, email));


--
-- Name: users_first_name_search_idx; Type: INDEX; Schema: public; Owner: police
--

CREATE INDEX users_first_name_search_idx ON public.users USING gin (to_tsvector('simple'::regconfig, (first_name)::text));


--
-- Name: users_last_name_search_idx; Type: INDEX; Schema: public; Owner: police
--

CREATE INDEX users_last_name_search_idx ON public.users USING gin (to_tsvector('simple'::regconfig, (last_name)::text));


--
-- Name: training_enrollments enrollment_attendance_status; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.training_enrollments
    ADD CONSTRAINT enrollment_attendance_status FOREIGN KEY (attendance_status_id) REFERENCES public.attendance_statuses(id);


--
-- Name: training_enrollments enrollment_enrollment_status; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.training_enrollments
    ADD CONSTRAINT enrollment_enrollment_status FOREIGN KEY (enrollment_status_id) REFERENCES public.enrollment_statuses(id);


--
-- Name: training_enrollments enrollment_officer; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.training_enrollments
    ADD CONSTRAINT enrollment_officer FOREIGN KEY (officer_id) REFERENCES public.users(id);


--
-- Name: training_enrollments enrollment_progress_status; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.training_enrollments
    ADD CONSTRAINT enrollment_progress_status FOREIGN KEY (progress_status_id) REFERENCES public.progress_statuses(id);


--
-- Name: training_enrollments enrollment_session; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.training_enrollments
    ADD CONSTRAINT enrollment_session FOREIGN KEY (session_id) REFERENCES public.training_sessions(id);


--
-- Name: formations formation_region; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.formations
    ADD CONSTRAINT formation_region FOREIGN KEY (region_id) REFERENCES public.regions(id);


--
-- Name: officers officer_formation; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.officers
    ADD CONSTRAINT officer_formation FOREIGN KEY (formation_id) REFERENCES public.formations(id);


--
-- Name: officers officer_posting; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.officers
    ADD CONSTRAINT officer_posting FOREIGN KEY (posting_id) REFERENCES public.postings(id);


--
-- Name: officers officer_rank; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.officers
    ADD CONSTRAINT officer_rank FOREIGN KEY (rank_id) REFERENCES public.ranks(id);


--
-- Name: officers officer_region; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.officers
    ADD CONSTRAINT officer_region FOREIGN KEY (region_id) REFERENCES public.regions(id);


--
-- Name: officers officer_user; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.officers
    ADD CONSTRAINT officer_user FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: roles_permissions roles_permissions_permission; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.roles_permissions
    ADD CONSTRAINT roles_permissions_permission FOREIGN KEY (permission_id) REFERENCES public.permissions(id);


--
-- Name: roles_permissions roles_permissions_role; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.roles_permissions
    ADD CONSTRAINT roles_permissions_role FOREIGN KEY (role_id) REFERENCES public.roles(id);


--
-- Name: roles_users roles_users_role; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.roles_users
    ADD CONSTRAINT roles_users_role FOREIGN KEY (role_id) REFERENCES public.roles(id);


--
-- Name: roles_users roles_users_user; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.roles_users
    ADD CONSTRAINT roles_users_user FOREIGN KEY (user_id) REFERENCES public.users(id);


--
-- Name: training_sessions session_facilitator; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.training_sessions
    ADD CONSTRAINT session_facilitator FOREIGN KEY (facilitator_id) REFERENCES public.users(id);


--
-- Name: training_sessions session_formation; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.training_sessions
    ADD CONSTRAINT session_formation FOREIGN KEY (formation_id) REFERENCES public.formations(id);


--
-- Name: training_sessions session_region; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.training_sessions
    ADD CONSTRAINT session_region FOREIGN KEY (region_id) REFERENCES public.regions(id);


--
-- Name: training_sessions session_status; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.training_sessions
    ADD CONSTRAINT session_status FOREIGN KEY (training_status_id) REFERENCES public.training_status(id);


--
-- Name: training_sessions session_workshop; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.training_sessions
    ADD CONSTRAINT session_workshop FOREIGN KEY (workshop_id) REFERENCES public.workshops(id);
...
ALTER TABLE ONLY public.tokens
    ADD CONSTRAINT user_tokens FOREIGN KEY (user_id) REFERENCES public.users(id);


--
-- Name: workshops workshop_category; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.workshops
    ADD CONSTRAINT workshop_category FOREIGN KEY (category_id) REFERENCES public.training_categories(id);


--
-- Name: workshops workshop_training_type; Type: FK CONSTRAINT; Schema: public; Owner: police
--

ALTER TABLE ONLY public.workshops
    ADD CONSTRAINT workshop_training_type FOREIGN KEY (training_type_id) REFERENCES public.training_types(id);
...
\unrestrict sHB3SV53P6fIhMyGe8vtol5P4pDlIwx7ptEbleRFjdt0vbzvIvZWuShxYBMABGp
