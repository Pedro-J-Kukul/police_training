...
func (app *appDependencies) routes() http.Handler {
	...
	router.Handler(http.MethodPost, "/v1/workshops", app.requirePermissions([]string{"CAN_CREATE", "CAN_CREATE_WORKSHOPS"}, http.HandlerFunc(app.createWorkshopHandler)))
	...
	router.Handler(http.MethodPatch, "/v1/workshops/:id", app.requirePermissions([]string{"CAN_MODIFY", "CAN_MODIFY_WORKSHOPS"}, http.HandlerFunc(app.updateWorkshopHandler)))

	// Training Categories routes (Admin only for write operations)
	router.Handler(http.MethodPost, "/v1/training/categories", app.requirePermissions([]string{"CAN_CREATE", "CAN_CREATE_TRAINING_CATEGORIES"}, http.HandlerFunc(app.createTrainingCategoryHandler)))
	...
	router.Handler(http.MethodPatch, "/v1/training/categories/:id", app.requirePermissions([]string{"CAN_MODIFY", "CAN_MODIFY_TRAINING_CATEGORIES"}, http.HandlerFunc(app.updateTrainingCategoryHandler)))

	// Training Types routes (Admin only for write operations)
	router.Handler(http.MethodPost, "/v1/training/types", app.requirePermissions([]string{"CAN_CREATE", "CAN_CREATE_TRAININGS"}, http.HandlerFunc(app.createTrainingTypeHandler)))
	...
	router.Handler(http.MethodPatch, "/v1/training/types/:id", app.requirePermissions([]string{"CAN_MODIFY", "CAN_MODIFY_TRAININGS"}, http.HandlerFunc(app.updateTrainingTypeHandler)))
	...
	router.Handler(http.MethodPost, "/v1/enrollment/status", app.requirePermissions([]string{"CAN_CREATE", "CAN_MODIFY_SELF"}, http.HandlerFunc(app.createEnrollmentStatusHandler)))
	...
	router.Handler(http.MethodPatch, "/v1/enrollment/status/:id", app.requirePermissions([]string{"CAN_MODIFY", "CAN_MODIFY_SELF"}, http.HandlerFunc(app.updateEnrollmentStatusHandler)))

	// Postings routes (Admin only for write operations)
	router.Handler(http.MethodPost, "/v1/postings", app.requirePermissions([]string{"CAN_CREATE", "CAN_CREATE_POSTINGS"}, http.HandlerFunc(app.createPostingHandler)))
	...
	router.Handler(http.MethodPatch, "/v1/postings/:id", app.requirePermissions([]string{"CAN_MODIFY", "CAN_MODIFY_POSTINGS"}, http.HandlerFunc(app.updatePostingHandler)))

	// Ranks routes (Admin only for write operations)
	router.Handler(http.MethodPost, "/v1/ranks", app.requirePermissions([]string{"CAN_CREATE", "CAN_CREATE_RANKS"}, http.HandlerFunc(app.createRankHandler)))
	...
	router.Handler(http.MethodPatch, "/v1/ranks/:id", app.requirePermissions([]string{"CAN_MODIFY", "CAN_MODIFY_RANKS"}, http.HandlerFunc(app.updateRankHandler)))

	// Regions routes (Admin only for write operations)
	router.Handler(http.MethodPost, "/v1/regions", app.requirePermissions([]string{"CAN_CREATE", "CAN_CREATE_REGIONS"}, http.HandlerFunc(app.createRegionHandler)))
	...
	router.Handler(http.MethodPatch, "/v1/regions/:id", app.requirePermissions([]string{"CAN_MODIFY", "CAN_MODIFY_REGIONS"}, http.HandlerFunc(app.updateRegionHandler)))

	// Formations routes (Admin only for write operations)
	router.Handler(http.MethodPost, "/v1/formations", app.requirePermissions([]string{"CAN_CREATE", "CAN_CREATE_FORMATIONS"}, http.HandlerFunc(app.createFormationHandler)))
	...
	router.Handler(http.MethodPatch, "/v1/formations/:id", app.requirePermissions([]string{"CAN_MODIFY", "CAN_MODIFY_FORMATIONS"}, http.HandlerFunc(app.updateFormationHandler)))

	// Officer routes
	router.Handler(http.MethodPost, "/v1/officers", app.requirePermissions([]string{"CAN_CREATE", "CAN_CREATE_OFFICERS"}, http.HandlerFunc(app.createOfficerHandler)))
	...
	router.Handler(http.MethodPatch, "/v1/officers/:id", app.requirePermissions([]string{"CAN_MODIFY", "CAN_MODIFY_OFFICERS"}, http.HandlerFunc(app.updateOfficerHandler)))
	router.Handler(http.MethodDelete, "/v1/officers/:id", app.requirePermissions([]string{"CAN_DELETE", "CAN_DELETE_OFFICERS"}, http.HandlerFunc(app.deleteOfficerHandler)))
